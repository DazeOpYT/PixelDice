...
import com.pixeldice.main.ReflectionUtils;
import com.pixeldice.main.ReflectionUtils.PackageType;
...
public enum ParticleEffect {
	...
	public void display(Location l, int i, int j, int k, int m, int n) {
